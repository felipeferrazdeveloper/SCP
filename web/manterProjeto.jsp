            ...
            <div class="conteudo">
                <form action="ManterProjetoController?acao=confirmarOperacao&operacao=${operacao}" 
                    ...
                    <div class="form-group col-md-4">        
                        ...
                        <input class="form-control input-sm" type="text" id="inicio" name="inicio" value="${projeto.inicio}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                    </div>     
                    <div class="form-group col-md-4">       
                        <label class="control-label">Fim: </label>
                        <input class="form-control input-sm" type="text" id="fim" name="fim" value="${projeto.fim}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                    </div>   
                    ...
                    <div class="form-group col-md-3">        
                        ...
                        <select class="form-control input-sm" id="situacao" name="situaca" value="${projeto.situacao}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>>                                
                            ...
                            <option <c:if test="${projeto.situacao == 'Finalizado'}"> selected </c:if> value="Finalizado">Finalizado</option>
                        </select>
                    </div>     
