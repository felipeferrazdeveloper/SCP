  ...
  <body>
    <div class="container">
        ...
        <div class="col-md-10">
            ...
            <div class="conteudo">
                <h2 class="col-md-12">Diretoria</h2>
            <form action="ManterDiretoriaController?acao=confirmarOperacao&operacao=${operacao}" 
              method="post" name="frmManterDiretoria">
                
                <h4 class="col-md-12">Diretoria</h4>
                <div class="form-group col-md-6">
                    <label id="codigoDiretoria">Codigo:</label>
                    <input class="form-control input-sm" type="text" id="idDiretoria" name="txtIdDieretoria" value="${diretoria.idDiretoria}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>/>
                </div>
                <div class="form-group col-md-6">
                    <label class="control-label" for="nome" id="nome">Nome:</label>     
                    <input class="form-control input-sm" type="text" id="nome" name="txtNome" value="${diretoria.nome}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>    
                </div>
