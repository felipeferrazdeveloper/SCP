            ...
            <form action="ManterCursoController?acao=confirmarOperacao&operacao=${operacao}" 
                  method="post" name="frmManterCurso" onSubmit="validarFormulario(this)">
                    ...
                    <div class="form-group col-md-6">
                        <label class="control-label" for="idCurso" id="codigoArea">Codigo:</label>    
                        <input class="form-control input-sm" type="text" id="idCurso" name="idCurso" value="${curso.idCurso}" <c:if test="${operacao != 'Incluir'}"> readonly </c:if>/>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="control-label" for="nome" id="nome">Nome:</label> 
                        <input class="form-control input-sm" type="text" id="nome" name="nome" value="${curso.nome}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                    </div>
