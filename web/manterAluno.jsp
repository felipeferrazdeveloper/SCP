    ...
    <body>
                            ...
                            <div class="tab-pane fade active in" id="dados">
                                    ...
                                    <form action="ManterAlunoController?acao=confirmarOperacao&operacao=${operacao}" method="post" name="frmManterAluno" onSubmit="validarFormulario(this)">
                                        ...
                                        <div class="form-group col-md-10">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input class="form-control input-sm" type="text" id="nasc" name="nascimento" value="${aluno.nascimento}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="endereco">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input class="form-control input-sm" type="text" id="cep" name="cep" value="${aluno.cep}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="control-label" for="end">Rua:</label>
                                        <input class="form-control input-sm" type="text" id="end" name="rua" value="${aluno.rua}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label class="control-label" for="num">Número:</label>
                                        <input class="form-control input-sm" type="text" id="num" name="numero" value="${aluno.numero}"  <c:if test="${operacao == 'Excluir'}"> readonly </c:if> onkeypress="return SomenteNumero(event)";/>
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control input-sm" type="text" id="bairro" name="bairro" value="${aluno.bairro}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="cid">Cidade:</label>
                                        <input class="form-control input-sm" type="text" id="cid" name="cidade" value="${aluno.cidade}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="estado">Estado:</label>
                                        <select class="form-control input-sm" id="estado" name="estado" value="${aluno.estado}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>>                                
                                        <option <c:if test="${aluno.estado == 'mg'}"> selected </c:if> value="mg">Minas Gerais</option>
                                        <option <c:if test="${aluno.estado == 'rj'}"> selected </c:if> value="rj">Rio de Janeiro</option>
                                        <option <c:if test="${aluno.estado == 'sp'}"> selected </c:if> value="sp">Sao Paulo</option>
                                        </select>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="contatos">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control input-sm" type="text" id="telefoneResidencial" name="telefoneResidencial" value="${aluno.telefoneResidencial}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="cel">Telefone Celular:</label>
                                        <input class="form-control input-sm" type="text" id="cel" name="celular"  value="${aluno.celular}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="telefoneTrabalho">Telefone Comercial:</label>
                                        <input class="form-control input-sm" type="text" id="telefoneTrabalho" name="telefoneTrabalho" value="${aluno.telefoneTrabalho}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="documentos">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input class="form-control input-sm" type="text" id="banco" name="banco" value="${aluno.banco}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>/>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="agencia">Agência:</label>
                                        <input class="form-control input-sm" type="text" id="agencia" name="agencia" value="${aluno.agencia}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if> onkeypress="return SomenteNumero(event)";/>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <label class="control-label" for="contaCorrente">Conta:</label>
                                        <input class="form-control input-sm" type="text" id="contaCorrente" name="contaCorrente" value="${aluno.contaCorrente}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if> onkeypress="return SomenteNumero(event)";/>
                                    </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#telefoneTrabalho, #cel, #telefoneResidencial").mask("(99) 9999-9999");
                $("#nasc").mask("99/99/9999");
                $("#cpf").mask("999.999.999-99");
                $("#idAluno").mask("9?99999");
