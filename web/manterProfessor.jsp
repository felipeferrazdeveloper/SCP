...
<!--<input type="text" class="form-control" id="date">-->
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="dados">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control input-sm" type="text" id="Data_Nascimento" name="Data_Nascimento" value="${professor.dataNascimento}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                            </div>                          
                            <div class="form-group col-md-4">
                    ...
                    <div class="tab-pane fade" id="contatos">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control input-sm" value="${professor.campus}" <c:if test="${operacao == 'Excluir'}"> readonly </c:if>>
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#Telefone_Residencial, #Celular").mask("(99) 9999-9999");
        $("#Data_Nascimento").mask("99/99/9999");
        $("#CPF").mask("999.999.999-99");
        $("#idProfessor").mask("9?99999");
        $("#siape").mask("999999");
