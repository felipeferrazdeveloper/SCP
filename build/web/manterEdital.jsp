  ...
  <body>
    <div class="container">
        ...
        <div class="col-md-10">
            ...
            <form action="ManterEditalController?acao=confirmarOperacao&operacao=${operacao}" 
                ...
                <div class="form-group col-md-4">       
                    <label class="control-label" for="numero">Numero do Edital:</label>
                    <input  class="form-control input-sm" type="text" id="numed" name="numero" value="${edital.numero}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                </div>   
                <div class="form-group col-md-4">  
                    <label class="control-label" for="diretorias" id="diretoria">Diretoria</label>
                    <select  class="form-control input-sm" name="optDiretoria" >
                ...
                <div class="form-group col-md-2">     
                    ...
                    <input placeholder="__/__/____"  class="form-control input-sm" type="text" id="inicio" name="inicio" value="${edital.inicio}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                </div>
                <div class="form-group col-md-2">        
                    <label class="control-label" for="fim" id="datfim">Data de Final:</label>
                    <input placeholder="__/__/____" class="form-control input-sm" type="text" id="fim" name="fim" value="${edital.fim}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>/>
                </div>
                <div class="form-group col-md-8">       
                    <label class="control-label" for="descricao">Descrição:</label>
                    <textarea   class="form-control input-sm" rows="4" cols="50" name="descricao" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>${edital.descricao}</textarea>
                </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#idEdital").mask("9999999");
        $("#numed").mask("0000", {clearIfNotMatch: true}); 
      }); 
    </script>-->
  </body>
</html>
