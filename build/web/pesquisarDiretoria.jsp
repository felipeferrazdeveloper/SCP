        ...
        <div class="col-md-10">
            ...
            <div class="conteudo"> 
                ...
                <form action="ManterDiretoriaController?acao=prepararOperacao&operacao=Incluir" method="post">       
                    <input type="submit" name="btnIncluir" value="Incluir Diretoria" class="btn btn-success" >
                </form>
                <br>
               ...
               <table class="table table-striped table-hover" id="table">
                   ...
                   <tbody>
                        <c:forEach items="${diretorias}" var="diretoria">
                            <tr>
                                <td><c:out value="${diretoria.getIdDiretoria()}"/></td>
                                <td><c:out value="${diretoria.getNome()}"/></td>
                                <td><a href="ManterDiretoriaController?acao=prepararOperacao&operacao=Editar&idDiretoria=<c:out value="${diretoria.getIdDiretoria()}"/>" class="btn btn-warning btn-xs"> Editar</a></td>
                                <td><a href="ManterDiretoriaController?acao=prepararOperacao&operacao=Excluir&idDiretoria=<c:out value="${diretoria.getIdDiretoria()}"/>" class="btn btn-danger btn-xs">Excluir</a></td>       
                            </tr>
                        </c:forEach>
                   </tbody> 
                </table> 
