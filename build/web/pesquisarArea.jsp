        ...
        <div class="col-md-10">
            ...
            <div class="conteudo"> 
                ...
                <form action="ManterAreaController?acao=prepararOperacao&operacao=Incluir" method="post">       
                    <input type="submit" name="btnIncluir" value="Incluir Área" class="btn btn-success" >
                </form>
                <br>
                ...
                <table class="table table-striped table-hover" id="table">
                    ...
                    <tbody>
                        <c:forEach items="${areas}" var="area">
                            <tr>
                                <td><c:out value="${area.getIdArea()}"/></td>
                                <td><c:out value="${area.getNome()}"/></td>
                                <td><a href="ManterAreaController?acao=prepararOperacao&operacao=Editar&idArea=<c:out value="${area.getIdArea()}"/>" class="btn btn-warning btn-xs"> Editar</a></td>
                                <td><a href="ManterAreaController?acao=prepararOperacao&operacao=Excluir&idArea=<c:out value="${area.getIdArea()}"/>" class="btn btn-danger btn-xs">Excluir</a></td>       
                            </tr>
                        </c:forEach>
                    </tbody>
                </table> 
