        ...
        <div class="col-md-10">
            ...
            <div class="conteudo"> 
                ...
                <form action="ManterCursoController?acao=prepararOperacao&operacao=Incluir" method="post">       
                    <input type="submit" name="btnIncluir" value="Incluir Curso" class="btn btn-success" >
                </form>
                <br>
               ...
               <table class="table table-striped table-hover " id="table">
                   ...
                   <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="ManterCursoController?acao=prepararOperacao&operacao=Editar&idCurso=<c:out value="${curso.getIdCurso()}"/>" class="btn btn-warning btn-xs"> Editar</a></td>
                            <td><a href="ManterCursoController?acao=prepararOperacao&operacao=Excluir&idCurso=<c:out value="${curso.getIdCurso()}"/>" class="btn btn-danger btn-xs">Excluir</a></td>       
                        </tr>
                        </c:forEach>
